...
const ErpIntegrationPage: React.FC = () => {
  return (
    <div className="w-full bg-black/30 backdrop-blur-sm border border-gray-700/50 rounded-2xl shadow-2xl p-6 sm:p-8 animate-fade-in">
        <h1 className="text-3xl font-black text-white text-center mb-2">ERP Integration</h1>
         <p className="text-center text-gray-400 mb-8">Connectors for SAP, Oracle NetSuite, etc.</p>
        <p className="text-center text-gray-300 mb-12 max-w-3xl mx-auto">
           Connect financial and supply chain data from your Enterprise Resource Planning system. This enables deeper operational insights, allowing for process optimization, cost attribution, and better correlation between infrastructure events and business operations.
        </p>

        <div className="flex flex-col md:flex-row items-center justify-center flex-wrap">
            <ArchBox title="SAP / Oracle NetSuite" color="border-orange-500">
            ...
            <RightArrow />
            <ArchBox title="Data Warehouse" color="border-yellow-500">
                <p className="text-sm text-gray-400 mt-2">Curated Operational Data</p>
            </ArchBox>
            <RightArrow />
            <ArchBox title="Enterprise Horizon Analytics" color="border-green-500">
                <p className="text-sm text-gray-400 mt-2">Process Optimization Models</p>
            </ArchBox>
        </div>
    </div>
  );
