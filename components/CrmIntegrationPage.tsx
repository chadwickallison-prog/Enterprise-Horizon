...
const CrmIntegrationPage: React.FC = () => {
  return (
    <div className="w-full bg-black/30 backdrop-blur-sm border border-gray-700/50 rounded-2xl shadow-2xl p-6 sm:p-8 animate-fade-in">
        <h1 className="text-3xl font-black text-white text-center mb-2">CRM Integration</h1>
        <p className="text-center text-gray-400 mb-8">Connectors for Salesforce, Dynamics 365, etc.</p>
        <p className="text-center text-gray-300 mb-12 max-w-3xl mx-auto">
            Integrate customer and deal data from your CRM platform to enrich the Contextual Relevance Framework. This allows Enterprise Horizon to correlate technical performance with direct impacts on customer journeys, sales pipelines, and revenue.
        </p>

        <div className="flex flex-col md:flex-row items-center justify-center flex-wrap">
            <ArchBox title="Salesforce / Dynamics 365" color="border-blue-500">
            ...
            <RightArrow />
            <ArchBox title="Data Transformation" color="border-yellow-500">
                <p className="text-sm text-gray-400 mt-2">Mapping to Unified Schema</p>
            </ArchBox>
            <RightArrow />
            <ArchBox title="Enterprise Horizon Data Lake" color="border-green-500">
                <p className="text-sm text-gray-400 mt-2">Enriches SII Analysis</p>
            </ArchBox>
        </div>
    </div>
  );
